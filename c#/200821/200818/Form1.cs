...
namespace _200818
{
    ...
    {   
        ...
        delegate void AddText_Callback(string str);
        // invoke 함수
        private void AddText(string str)
        {
            if (this.textBox2.InvokeRequired)
            {
                AddText_Callback AddCB = new AddText_Callback(AddText);
                this.Invoke(AddCB, new object[] { str });
            }
            else
            {
                textBox2.Text += str;
        ...
        private void serialPort1_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            // textBox2.Text = RecvBuf; // 이렇게 하면 안됨. 오류 생김
            AddText(RecvBuf);
            RecvBuf = "";
        }
