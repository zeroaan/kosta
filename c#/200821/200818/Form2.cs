...
namespace _200818
{
    public partial class PortSet : Form
    {
        ...
        private void PortSet_Shown(object sender, EventArgs e)
        {
        ...
        public PortSet()
        {
            ...
            {
                cbPortno.Items.Add(portNames[i]);
            }
        }

        private void port_Click(object sender, EventArgs e)
        {
            ConnectionStr = cbPortno.Text + cbBaudrate.Text + cbParity.Text[0] + cbDatabits.Text + cbStopbit.Text;
